...
class OneDeck {
    ...
    public OneDeck()
    {
        ...
        System.out.println(e.getMessage());
            ...
            playDeck = new ArrayList<Card>(saveDeck);
    }
    ...
    public List<Card> deal(int numberCards) throws PlayingCardException
    {
        ...
        if(numberCards > playDeck.size()){
            throw new PlayingCardException("you dont have enough cards to deal");
        
        }
        for (int i=0; i < numberCards; i++){
        dealCards.add(playDeck.remove(0));
        }
        return dealCards;
    }
